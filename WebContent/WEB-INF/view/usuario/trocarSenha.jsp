...
<body>
									...
									<div class="single-cool-fact">
										...
										<div class="dropdown">
											<div id="myDropdown" class="dropdown-content">
												<a href="alterarDados">Alterar Dados</a> <a href="#">Excluir Conta</a>
												<a href="#">Histórico de Compras</a> <a href="trocarSenha">Alterar Senha</a> <a href="home">Sair</a>
											</div>
										</div>
	...
	<form action="alterarDados" method="POST">
		...
		<label>Senha Atual:</label> <input type="text" class="form-control"
			name="senha" required> <label>Nova Senha:</label> <input
			type="senha" class="form-control" name="senha" required> <label>Confirme a senha:</label>
