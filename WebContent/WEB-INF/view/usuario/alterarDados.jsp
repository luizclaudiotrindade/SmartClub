	...
	<div class="row" style="background-color: rgba(203, 134, 112, 0.65); margin-right: 1px; margin-left: 0px; margin-top: 72px;">
		<div class="row">
			<div class="col-md-12"
				...
				<h2 style="color: white">Bem vindo a tela de alteração de dados:</h2>
				<p style="color: white">Preencha todos os campos com seus dados:</p>
			</div>
		</div>
	</div>
	<style>
		...
		<div class="container">
			...
			<tbody>
				...
				<div class="form-group">
								<label style="color: white;" class="col-md-4 control-label">Nome</label>
								<div class="col-md-6 inputGroupContainer">
									<div class="input-group">
										<span class="input-group-addon"><i
											class="glyphicon glyphicon-home"></i></span><input name="nome"
							...
							<div class="form-group">
								<label style="color: white;" class="col-md-4 control-label">Email</label>
								<div class="col-md-6 inputGroupContainer">
									<div class="input-group">
										<span class="input-group-addon"><i
							...
							<div class="form-group">
								<label style="color: white;" class="col-md-4 control-label">Telefone</label>
								<div class="col-md-6 inputGroupContainer">
									<div class="input-group">
										<span class="input-group-addon"><i
											class="glyphicon glyphicon-home"></i></span><input name="telefone"
							...
							<div class="row">
								<input class="btn btn-primary" style="margin-left: 112px;" type="submit" value="Salvar Alterações">
