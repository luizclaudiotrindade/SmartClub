	...
	<form action="cadastro" method="post"
		...
		<div style="margin-left: 3%; margin-top: 12%" class="row">
			...
			<div class="col">
				...
				<input type="text" class="form-control" placeholder="CNPJ" name="cnpj" required><br>
				...
				<input type="text" class="form-control" placeholder="Bairro"name="bairro" required><br>

				<input type="text" class="form-control" placeholder="Cidade" name="cidade" required><br>

				<input type="text" class="form-control" placeholder="Estado" name="estado" required><br>
