...
<section class="breadcumb-area bg-img d-flex align-items-center justify-content-center">	</section>
   ...
   <h1 style="text-align: center; color: black; margin-top: 200px;background: #000000; color: #ffffff; padding: 10px; border: 5px solid #FA8072; ">Hotel Cadastrado com sucesso!</h1>
